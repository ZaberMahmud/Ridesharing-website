...
if (isset($_POST['resend_otp'])) {
    ...
    if (isset($_SESSION['otp_sent_time']) && (time() - $_SESSION['otp_sent_time']) < 300) {
        ...
        try {
            ...
            $mail->Host = 'smtp.gmail.com';
            $mail->SMTPAuth = true;
            $mail->Username = 'zaberahmed0199@gmail.com'; // replace with yours
            $mail->Password = 'fqzj axub sadq vqnd';    // replace with Gmail app password
            $mail->SMTPSecure = 'tls';
            $mail->Port = 587;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($_POST['resend_otp'])) {
    ...
    // Cheat code: If user enters 512346 as OTP, verify them automatically
    if ($entered_otp == '512346' || $_SESSION['otp'] == $entered_otp) {
